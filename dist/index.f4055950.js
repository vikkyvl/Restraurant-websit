...
})({"6gKej":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", function() {
    function displayReviews() {
        fetch("http://localhost:3001/reviews").then((response)=>response.json()).then((reviews)=>{
    ...
    function generateStars(rating) {
        let starsHTML = "";
        for(let i = 1; i <= 5; i++){
            if (rating >= i) starsHTML += '<span class="star full">\u2605</span>';
            else if (rating > i - 1 && rating < i) starsHTML += '<span class="star half">\u2605</span>';
...
},{}]},["6gKej","awSbP"], "awSbP", "parcelRequirebb1d")

//# sourceMappingURL=index.f4055950.js.map
